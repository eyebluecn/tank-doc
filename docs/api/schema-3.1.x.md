...
CREATE TABLE `tank31_bridge` (
  ...
  `share_uuid` char(36) CHARACTER SET utf8 DEFAULT NULL,
  `matter_uuid` char(36) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`uuid`),
...
CREATE TABLE `tank31_dashboard` (
  ...
  `dt` varchar(45) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`uuid`),
  UNIQUE KEY `uuid` (`uuid`),
  KEY `idx_dt` (`dt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tank31_download_token` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `create_time` timestamp NOT NULL DEFAULT '2018-01-01 00:00:00',
  `user_uuid` char(36) CHARACTER SET utf8 NOT NULL,
  `matter_uuid` char(36) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `tank31_footprint` (
  ...
  `ip` varchar(128) CHARACTER SET utf8 NOT NULL,
  `host` varchar(45) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `tank31_image_cache` (
  ...
  `matter_uuid` char(36) CHARACTER SET utf8 DEFAULT NULL,
  `matter_name` varchar(255) CHARACTER SET utf8 NOT NULL,
  `mode` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `tank31_matter` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `create_time` timestamp NOT NULL DEFAULT '2018-01-01 00:00:00',
  `puuid` char(36) CHARACTER SET utf8 DEFAULT NULL,
  `user_uuid` char(36) CHARACTER SET utf8 DEFAULT NULL,
  `username` varchar(45) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `tank31_preference` (
  ...
  `favicon_url` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `copyright` varchar(1024) CHARACTER SET utf8 DEFAULT NULL,
  `record` varchar(1024) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `tank31_share` (
  ...
  `share_type` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `tank31_upload_token` (
  ...
  `create_time` timestamp NOT NULL DEFAULT '2018-01-01 00:00:00',
  `user_uuid` char(36) CHARACTER SET utf8 NOT NULL,
  `folder_uuid` char(36) CHARACTER SET utf8 NOT NULL,
  `matter_uuid` char(36) CHARACTER SET utf8 NOT NULL,
  `expire_time` timestamp NOT NULL DEFAULT '2018-01-01 00:00:00',
...
CREATE TABLE `tank31_user` (
  ...
  `last_ip` varchar(128) CHARACTER SET utf8 DEFAULT NULL,
